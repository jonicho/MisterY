...
public class Player {
	 ...
	 * @param name The name.
	 * @param mrY Whether the player is mrY.
	 */
	 ...
	 * @param map The map.
	 * @param taxiTickets The initial taxi tickets.
	 * @param busTickets The initial bus tickets.
	 * @param undergroundTickets The initial underground tickets.
	 */
	...
	/**
	 * Chooses a random station to start on which is neither mister y nor another player.
	 */
